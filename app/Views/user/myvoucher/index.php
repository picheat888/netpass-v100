...
$myVoucherJs = FCPATH . 'assets/js/myvoucher/index.js';
?>
<script type="application/json" id="np-myvoucher-data"><?= json_encode($npMyVoucher, JSON_HEX_TAG | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE) ?></script>
<script src="<?= base_url('assets/js/myvoucher/index.js') ?>?v=<?= is_file($myVoucherJs) ? filemtime($myVoucherJs) : '1' ?>"></script>
<?= $this->endSection() ?>
