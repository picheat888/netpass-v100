...
(function () {
    ...
    if (printBtn) {
        ...
        const CSS_ICONS = NP_VOUCHER.assets.cssIcons;
        const CSS_FONTS = NP_VOUCHER.assets.cssFonts;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const CSS_FONTS = NP_VOUCHER.assets.cssFonts;
    const TICKET_LBL = {
        title: NP_VOUCHER.i18n.title,
        wifi:  NP_VOUCHER.i18n.wifi,
        loc:   NP_VOUCHER.i18n.loc,
        dur:   NP_VOUCHER.i18n.dur,
        exp:   NP_VOUCHER.i18n.exp,
        scan:  NP_VOUCHER.i18n.scan,
    };
    ...
    selPrintBtn.addEventListener('click', async function () {
        ...
        try {
            const url = NP_VOUCHER.urls.tickets + '?' + [...selected].map((id) => 'ids[]=' + encodeURIComponent(id)).join('&');
